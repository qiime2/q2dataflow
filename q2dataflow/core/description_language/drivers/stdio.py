...
def stdio_files():
    out = tempfile.NamedTemporaryFile(prefix='q2description_language-stdout-', suffix='.log')
    err = tempfile.NamedTemporaryFile(prefix='q2description_language-stderr-', suffix='.log')
